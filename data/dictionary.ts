    ...
    meanings: [
      {
        ...
        tags: {
          ...
          invisible: [
            ...
            'irreg(imper_affirm, tú)=ten',
            'irreg(imper_affirm, ud)=tenga',
            'irreg(imper_affirm, vosotros)=tened',
            'irreg(imper_neg, tú)=no tengas',
          ],
        },
    ...
    meanings: [
      {
        ...
        tags: {
          ...
          invisible: [
            ...
            'irreg(imper_affirm, tú)=sé',
            'irreg(imper_affirm, ud)=sea',
            'irreg(imper_affirm, vosotros)=sed',
            'irreg(imper_neg, tú)=no seas',
          ],
        },
